...
#define GET_COLOR_VALUE_FREQUENCY              30   //hz
...
void getColorCallback(const std_msgs::Bool& power_msg);
...
ros::Subscriber<std_msgs::Bool> get_color_value_sub("do_get_color_value", getColorCallback);
...
ros::Publisher color_sensor_value_pub("colorSensorValue", &colorValues);
...
/*******************************************************************************
* Declaration for color sensor
*******************************************************************************/
Adafruit_TCS34725 tcs = Adafruit_TCS34725(TCS34725_INTEGRATIONTIME_50MS, TCS34725_GAIN_4X);
bool doGetColor = false;
